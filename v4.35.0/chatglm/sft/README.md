...
Traceback (most recent call last):
  File "/data/llm_project/v4.35.0/chatglm/sft/run_clm.py", line 900, in <module>
    main()
  File "/data/llm_project/v4.35.0/chatglm/sft/run_clm.py", line 876, in main
    config, tokenizer, model = load_pretrained_model_and_tokenizer(model_args)
  File "/data/llm_project/v4.35.0/chatglm/sft/run_clm.py", line 435, in load_pretrained_model_and_tokenizer
  ...
  File "/home/ubuntu/.cache/huggingface/modules/transformers_modules/chatglm-6b/tokenization_chatglm.py", line 196, in __init__
    super().__init__(
  ...
  File "/home/ubuntu/.cache/huggingface/modules/transformers_modules/chatglm-6b/tokenization_chatglm.py", line 248, in get_vocab
    vocab = {self._convert_id_to_token(i): i for i in range(self.vocab_size)}
  File "/home/ubuntu/.cache/huggingface/modules/transformers_modules/chatglm-6b/tokenization_chatglm.py", line 244, in vocab_size
    return self.sp_tokenizer.num_tokens
AttributeError: 'ChatGLMTokenizer' object has no attribute 'sp_tokenizer'. Did you mean: '_tokenize'?
[2023-11-23 14:56:57,350] torch.distributed.elastic.multiprocessing.api: [ERROR] failed (exitcode: 1) local_rank: 0 (pid: 193870) of binary: /home/ubuntu/anaconda3/envs/trans4.35.0/bin/python
```
